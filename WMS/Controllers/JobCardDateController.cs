    ...
    public class JobCardDateController : Controller
    {
        ...
        private bool AddJobCardDataToDatabase(string _empDate, int _empID, DateTime _currentDate, int _userID, JobCardApp jcApp)
        {
            ...
            try
            {
                ...
                ////////////I am following NHA Code and there is AppID, But now in This scp project i have JCAppID/////////////////
...
////////////////////////////////JCAppID is in this project but in nha Project here is AppID///////////////

                jcEmps = db.JobCardEmps.Where(aa => aa.JCAppID == id).ToList();
                if (jcEmps.Count > 0)
                {
        ...
        private void RemoveFromAttData(JobCardEmp item)
        {
            try
            {
                ...
                //////////////////TO-DO////////////////
                ///////////Manual process is not completed //////////
                ////////////////////////////////////////////////////
