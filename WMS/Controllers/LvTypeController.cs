...
namespace WMS.Controllers
{
    public class LvTypeController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="LvType1,LvDesc,FldName,HalfLeave,HalfLvCode,HalfAbCode,MaxDays,WorkDays,VacDays,MonthProcess,UpdateBalance,LvStatus,Enable,CompanyID")] LvType lvtype)
        {
            if (ModelState.IsValid)
            {
